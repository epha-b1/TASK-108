...
const config = {
  ...
  "inlineSchemaHash": "e95085c09b906d93265ae20d8b9eedddcbf706178851d7b23f1dddd0d0afd89a",
  "copyEngine": true
}
...
path.join(process.cwd(), "src/models/prisma/libquery_engine-debian-openssl-3.0.x.so.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-linux-musl-openssl-3.0.x.so.node");
path.join(process.cwd(), "src/models/prisma/libquery_engine-linux-musl-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
